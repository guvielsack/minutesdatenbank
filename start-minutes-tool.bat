...
echo Beende eventuell laufenden Server auf Port 8002 ...
...
set INITIAL_ADMIN_PASSWORD=change-me-on-first-deploy

echo.
echo Minutes-Tool startet unter: %URL%
echo Lokaler Admin: admin / change-me-on-first-deploy
